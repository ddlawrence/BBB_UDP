...
.word	def              // 12  EDMA client 0
.word	def              // 13  EDMA protection error
.word	def              // 14  EDMA CC error
...
.word	def              // 28  MMC/SD 1
.word	def              // 29  MMC/SD 2
.word	def              // 30  I2C 2
.word	def              // 31  eCAP 0
...
.word	CPSWCore0RxIsr   // 41  Ethernet core 0 rx dma completion
.word	CPSWCore0TxIsr   // 42  Ethernet core 0 tx dma completion
...
.word	def              // 70  I2C 0
.word	def              // 71  I2C 1
.word	def // uart0_isr        // 72  UART 0  -  UART0INT
.word	def              // 73  UART 1
.word	def              // 74  UART 2
.word	def // rtc_isr          // 75  RTC periodic  -  RTCINT
...
.word	def              // 112 EDMA TC 0 error
.word	def              // 113 EDMA TC 1 error
.word	def              // 114 EDMA TC 2 error
